...
public class HexOPConfig {
    ...
    public static boolean BypassesSilencedEnvRestrictions() {
        return imp.BypassesSilencedEnvRestrictions();
    }
    ...
    public interface API {
        ...
        String desc_BypassesSilencedEnvRestrictions = "enable to remove silenced casting for `Delay` pattern, and see mishaps and prints inside";
        ...
        String desc_EnablesAmethystCircle = "media waves from circles go through amethyst budding blocks, and accelerates their crystal growth";
        String desc_AmethystCircleSingleChargeCost = "each time media reduces for crystal growth passing a budding block";
        String desc_AmethystCircleFullPowerLevel = "max possible charging level of the wave: growth strength = min(this, wave total media / single cost)";
        ...
        boolean BypassesSilencedEnvRestrictions();
        int TrulyHurtLevel();
